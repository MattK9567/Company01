...
<head>
  ...
  <title>Prenájom športovísk</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>Dashboard/domov" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>Š</b>SVK</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Športoviská</b>SVK</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="http://frnko.com/wp-content/uploads/2017/03/Big-Letter-A-Coloring-Page.jpg" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!--Domov-->
        <li class="treeview">
          <a href="<?php echo base_url(); ?>Dashboard/domov">
